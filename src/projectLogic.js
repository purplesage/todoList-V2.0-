...
//* project 'li' maker.
function projectFilter(TDobject) {
    ...
    projectLi.addEventListener('click', () => {
            ...
            pFilter();
            /* projectNumberUpdate(pFilter(), numberP); */
            console.log(pFilter())
        });

    return {projectSwitch, pFilter};
};
...
const projectNumberUpdate = (filter, numberDisplay) => {

    const tFilterLength = filter;
    numberDisplay.textContent = tFilterLength === 0? "": tFilterLength;
